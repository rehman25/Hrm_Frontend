...
import Transaction_Confirmations from '../Employee_leaves/Transaction_Confirmations'
import Transaction_Increment from '../Employee_leaves/Transaction_Increment'
const routing = () => {
  return (
    <>
      <Router>
        <Routes>
          ...
          <Route path="/Transaction_Confirmations" element={<Transaction_Confirmations />} />
